...
! lev+60=60,61,... disp
! lev+10=10,11,... Tr
! 150, 5 are changed to variables in cpp
...
!======================================================================!
      ...
      use state_inc
      implicit real*8(a-h,o-z)
      parameter(Nray0=150,levmax=5,ixm2=ixm+2,iym2=iym+2,izm2=izm+2, &
...
! Slave Solve_I_0
      ...
      parameter (Nray0=150,Lmax=ng*3,levmax=5, ixm2=ixm+2,iym2=iym+2,izm2=izm+2)
      common /grid/ xf(0:ixm2), yf(0:iym2), zf(0:izm2), dx0, eps, xcent, ycent, zcent
      common /const/ h,lc,bc
      real*8 lc
! velocity field
