...
real ::   h2( 0:IXMAX,0:IYMAX,0:IZMAX)  ! h2 fraction 
real ::   tem2( 0:IXMAX2,0:IYMAX2,0:IZMAX2)  ! temperature
real ::   rho2( 0:IXMAX2,0:IYMAX2,0:IZMAX2)  ! density
real ::   h22( 0:IXMAX2,0:IYMAX2,0:IZMAX2)  ! h2 fraction 
real, dimension(0:ixmax, 0:iymax, 0:izmax) :: u,v,w 
real, dimension(0:ixmax2, 0:iymax2, 0:izmax2) :: u2,v2,w2 
...
! for original data
open(1,file='bf0390', form='unformatted',status='old')
read(1) time 
read(1) u,v, w, rho, tem, h2
!read(1) rho, tem, u,v,w
close(1)
...
open(1,file='bf0390_small.data', form='unformatted',status='unknown')
write(1) time 
...
print*,'time = ', time
print*,'max, min of rho', maxval(rho2), minval(rho2)
print*,'max, min of tem', maxval(tem2), minval(tem2)
print*,'max, min of u', maxval(u2), minval(u2)
print*,'max, min of v', maxval(v2), minval(v2)
print*,'max, min of w', maxval(w2), minval(w2)

!open(1,file='agn_input2.data', form='unformatted',status='unknown')
!write(1) ng/2 
