...
open(1,file='pma0129_128.data', form='unformatted',status='old')
read(1) nx, ny, nz
read(1) time 
...
!open(3,file='agn_input128.data', form='unformatted',status='unknown')
open(3,file='nonlte_input128_pma0129.data', form='unformatted',status='unknown')
write(3) ng
